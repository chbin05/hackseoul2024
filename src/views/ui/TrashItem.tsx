...
const TrashItem = ({id, icon, text, checked, onChange}) => {
  const handleChange = (e) => {
    onChange(e, e.currentTarget.id)
  }

  return (
    <span className={styles.wrap}>
      <input type="radio" className={styles.input} id={id} checked={checked} onChange={handleChange} />
